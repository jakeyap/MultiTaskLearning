...
PYTHONIOENCODING=utf-8 CUDA_VISIBLE_DEVICES=0 python main_deep.py --N_EPOCHS=2 \
    --BATCH_SIZE_TRAIN=1 --BATCH_SIZE_TEST=4 --LOG_INTERVAL=1 \
    --LEARNING_RATE=0.00001 --OPTIMIZER='ADAM' --MODELNAME='ModelF1' \
    --NAME='test' --DEBUG --WEIGHTED_STANCE --THREAD_LENGTH_DIVIDER=8 \
    --MAX_POST_PER_THREAD=8 --EXPOSED_POSTS=4 --DO_TRAIN
