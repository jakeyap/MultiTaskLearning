...
# exp9
PYTHONIOENCODING=utf-8 CUDA_VISIBLE_DEVICES=0 python main.py --N_EPOCHS=1 --BATCH_SIZE_TRAIN=1 --BATCH_SIZE_TEST=2 --LOG_INTERVAL=1 --LEARNING_RATE=0.00001 --OPTIMIZER='ADAM' --MODELNAME='ModelC1' --NAME='test' --DEBUG --DO_TRAIN